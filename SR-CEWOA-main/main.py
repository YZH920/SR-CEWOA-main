...
import src.baselines.ASWOA as WOA
...
from src.baselines import MWOA, ASWOA, BWO,WOA
...
if __name__ == "__main__":
    ...
    elif (dataset == "QWS" or dataset == "qws") and approach == "BWO":
        parakey = config.options("QWS-BWO")
        paravalue = [config.get("QWS-BWO", key) for key in parakey]
        if len(sys.argv) == 4:
            paravalue[-3] = sys.argv[3]
        model = BWO.BWO("QWS", int(paravalue[0]), int(paravalue[1]), int(paravalue[2]), int(paravalue[3]),
                        int(paravalue[4]), int(paravalue[5]), int(paravalue[6]), int(paravalue[7]),
                        int(paravalue[8]), int(paravalue[9]))
        print("QWSBWO")
        model.start()

    elif (dataset == "QWS" or dataset == "qws") and approach == "ASWOA":
        parakey = config.options("QWS-ASWOA")
        paravalue = [config.get("QWS-ASWOA", key) for key in parakey]
        if len(sys.argv) == 4:
            paravalue[-3] = sys.argv[3]
        model = ASWOA.WOA("QWS", int(paravalue[0]), int(paravalue[1]), int(paravalue[2]), int(paravalue[3]),
                           int(paravalue[4]), int(paravalue[5]), int(paravalue[6]), int(paravalue[7]),
                           int(paravalue[8]), int(paravalue[9]))
    ...
    elif dataset == "Normal" and approach == "MWOA":
        parakey = config.options("Normal-MWOA")
        paravalue = [config.get("Normal-MWOA", key) for key in parakey]
        if len(sys.argv) == 4:
            paravalue[-3] = sys.argv[3]
        model = MWOA.WOA("Normal", int(paravalue[0]), int(paravalue[1]), int(paravalue[2]), int(paravalue[3]),
                        int(paravalue[4]), int(paravalue[5]), float(paravalue[6]), int(paravalue[7]),
                        int(paravalue[8]), int(paravalue[9]))
        print("NormalMWOA")
        model.start()

    elif dataset == "Normal" and approach == "BWO":
        parakey = config.options("Normal-BWO")
        paravalue = [config.get("Normal-BWO", key) for key in parakey]
        if len(sys.argv) == 4:
            paravalue[-3] = sys.argv[3]
        model = BWO.BWO("Normal", int(paravalue[0]), int(paravalue[1]), int(paravalue[2]), int(paravalue[3]),
                        int(paravalue[4]), int(paravalue[5]), float(paravalue[6]), int(paravalue[7]),
                        int(paravalue[8]), int(paravalue[9]))
        print("NormalBWO")
        model.start()

    elif dataset == "Normal" and approach == "ASWOA":
        parakey = config.options("Normal-ASWOA")
        paravalue = [config.get("Normal-ASWOA", key) for key in parakey]
        if len(sys.argv) == 4:
            paravalue[-3] = sys.argv[3]
        model = ASWOA.WOA("Normal", int(paravalue[0]), int(paravalue[1]), int(paravalue[2]), int(paravalue[3]),
                        int(paravalue[4]), int(paravalue[5]), float(paravalue[6]), int(paravalue[7]),
                        int(paravalue[8]), int(paravalue[9]))
        print('NormalASWOA')
        model.start()
